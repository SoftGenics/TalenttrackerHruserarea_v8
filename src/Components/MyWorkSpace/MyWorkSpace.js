...
const MyWorkSpace = () => {
 ...
 const handleShowdropdown = () => 
  ...
  return (
    <div onLoad={()=>{toast.warning("Work is on Progress...")}}>
        ...
        <Table className='data-table' hover>
          ...
          <tbody>
            <tr>
              ...
              <td className='position'>Mahindra & Mahindra Ltd.<br></br><span><a href='https://talenttrackerhr.in/'><i className="fas fa-globe me-2"></i></a> | <a href='https://www.linkedin.com/login'><i className="fab fa-linkedin ms-2 me-2"></i></a> | <OverlayTrigger placement='bottom' overlay={<Tooltip id="tooltip-disabled">View All Information</Tooltip>}><i className="fas fa-eye ms-2 " onClick={handleShow1}></i></OverlayTrigger> | <OverlayTrigger placement='bottom' overlay={<Tooltip id="tooltip-disabled">Open Client Details</Tooltip>}><i className='fas fa-user ms-2'></i></OverlayTrigger></span> </td>
              ...
              <td><Link to="/submit"><Button><i className="fas fa-at"></i></Button></Link></td>
              <td>10</td>
              <td className='jdstatus'><Button variant='danger' className='me-2'>Pending delivery</Button></td>
              <td>19-05-2022 7:00.PM</td>
              <td>Good</td>
              <td><Button variant='outline-danger' onClick={handleShow2}><i className="fas fa-gift"></i> Offer</Button></td>
            </tr>
            <tr>
              <td>2</td>
              <td>user002</td>
              ...
              <td>Good</td>
              <td><Button variant='outline-success' onClick={handleShow2}><i className="fas fa-gift"></i> Offer</Button></td>
            </tr>
            <tr>
              <td>3</td>
              <td>user003</td>
              ...
              <td>Good</td>
              <td><Button variant='warning' onClick={handleShow2}><i className="fas fa-gift"></i> Offer</Button></td>
            </tr>
            <tr>
              <td>4</td>
              <td>user004</td>
              ...
              <td>19-05-2022 7:00.PM</td>
              <td>Good</td>
              <td><Button variant='success' onClick={handleShow2}><i className="fas fa-gift"></i> Offer</Button></td>
            </tr>
            <tr>
              <td>5</td>
              <td>user005</td>
              ...
              <td>Good</td>
              <td><Button variant='danger' onClick={handleShow2}><i className="fas fa-gift"></i> Offer</Button></td>
            </tr>
            <tr>
              <td>6</td>
              <td>user006</td>
              ...
              <td>Good</td>
              <td><Button variant='secondary' onClick={handleShow2}><i className="fas fa-gift"></i> Offer</Button></td>
            </tr>
            <tr>
              <td>7</td>
              <td>user007</td>
              ...
              <td>Good</td>
              <td><Button><i className="fas fa-gift" onClick={handleShow2}></i> Offer</Button></td>
            </tr>
