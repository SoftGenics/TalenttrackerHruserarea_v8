...
const handleEnable = () => setedit(!edit)
  return (
    <div>
                ...
                <Form>
                    <Row>
                       ...
                       <Form.Group>
                           ...
                           <Form.Control type='text' defaultValue="C" name="category" {...edit? disabled : disabled } />
                       </Form.Group>
                    ...
                    <Button variant='primary' className='mt-3'>save</Button><Button variant='secondary' className='mt-3 mx-3' onClick={handleEnable}>edit</Button>
                    </div>
                    </Form>
